...
AbstractGrantType.prototype.generateAccessToken = function(user, resultOfAccessTokenExpiresAt) {
  if (this.model.generateAccessToken) {
    return Promise.try(this.model.generateAccessToken,[user, resultOfAccessTokenExpiresAt], this.model);
  }
...
AbstractGrantType.prototype.generateRefreshToken = function(user, resultOfRefreshTokenExpiresAt) {
  if (this.model.generateRefreshToken) {
    return Promise.try(this.model.generateRefreshToken,[user, resultOfRefreshTokenExpiresAt], this.model);
  }
