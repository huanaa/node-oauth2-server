...
PasswordGrantType.prototype.saveToken = function(user, client, scope) {
  var resultOfAccessTokenExpiresAt = this.getAccessTokenExpiresAt();
  var resultOfRefreshTokenExpiresAt = this.getRefreshTokenExpiresAt();
  var fns = [
    this.validateScope(user, client, scope),
    this.generateAccessToken(user, resultOfAccessTokenExpiresAt),
    this.generateRefreshToken(user, resultOfRefreshTokenExpiresAt),
    resultOfAccessTokenExpiresAt,
    resultOfRefreshTokenExpiresAt
  ];
